// src/components/codemaze/CodeMazeLevel10.jsx
import React, { useState } from 'react';

export default function CodeMazeLevel10({ onBack }) {
  ...
  const [walls] = useState([
    { x: 1, y: 0 }, { x: 3, y: 0 }, { x: 5, y: 0 }, { x: 7, y: 0 }, { x: 9, y: 0 },
  ...
  const puzzlePieces = [
    ...
    { id: 5, code: 'def navigate_maze():', type: 'function' },
    { id: 6, code: 'def solve_path():', type: 'function' },
    { id: 7, code: 'if can_move_right():', type: 'condition' },
    { id: 8, code: 'elif can_move_down():', type: 'condition' },
    { id: 9, code: 'elif can_move_left():', type: 'condition' },
    { id: 10, code: 'else:', type: 'condition' },
    { id: 11, code: 'while not_at_exit():', type: 'loop' },
    { id: 12, code: 'try:', type: 'exception' },
    { id: 13, code: 'except PathBlockedError:', type: 'exception' },
    { id: 14, code: 'finally:', type: 'exception' },
    { id: 15, code: 'return True', type: 'return' },
    { id: 16, code: 'break', type: 'control' },
    { id: 17, code: 'continue', type: 'control' }
  ];
  ...
  const runCode = () => {
    ...
    if (isSolutionCorrect) {
      setResult('Поздравляем! Вы завершили все уровни Лабиринта кода!');
      setPlayerPosition({ x: 9, y: 9 });
    } else {
      setResult('Попробуйте еще раз. Нужно создать комплексное решение для финального лабиринта');
    }
  };
      ...
      <header className="bg-black/20 backdrop-blur-sm border-b border-blue-500/20">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">Лабиринт кода - Уровень 10</h1>
            <button 
              onClick={onBack}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl font-bold text-white">Финальный вызов</h2>
                <p className="text-gray-300">Последний и самый сложный лабиринт</p>
              </div>
                ...
                {isCorrect && (
                  <div className="mt-6 p-4 bg-blue-900/30 border border-blue-500/30 rounded-lg">
                    <p className="text-blue-400 font-semibold text-center">
                      Поздравляем! Вы завершили все уровни Лабиринта кода!
                    </p>
