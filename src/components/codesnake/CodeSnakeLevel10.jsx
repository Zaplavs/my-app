// src/components/codesnake/CodeSnakeLevel10.jsx
import React, { useState } from 'react';

export default function CodeSnakeLevel10({ onBack }) {
  ...
  const puzzlePieces = [
    ...
    { id: 11, code: 'for i in range(10):', type: 'loop' },
    { id: 12, code: 'def navigate_maze():', type: 'function' }
  ];
  ...
  const runCode = () => {
    ...
    if (isSolutionCorrect) {
      setResult('Поздравляем! Вы завершили все уровни Змейки программиста!');
      setSnakePosition({ x: 0, y: 1 });
      setBerriesCollected(10);
    } else {
      setResult('Попробуйте еще раз. Нужно пройти финальный вызов и собрать все ягоды');
    }
  };
      ...
      <header className="bg-black/20 backdrop-blur-sm border-b border-green-500/20">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">Змейка программиста - Уровень 10</h1>
            <button 
              onClick={onBack}
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-300">Самый сложный уровень: 10x10 поле с максимальным количеством ягод</p>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8">
                ...
                <div className="mt-4 text-center text-gray-300">
                  ...
                  <p className="mt-2">Собрано ягод: {berriesCollected}/10</p>
                </div>
              </div>
                ...
                {isCorrect && (
                  <div className="mt-6 p-4 bg-green-900/30 border border-green-500/30 rounded-lg">
                    <p className="text-green-400 font-semibold text-center">
                      Поздравляем! Вы завершили все уровни Змейки программиста!
                    </p>
