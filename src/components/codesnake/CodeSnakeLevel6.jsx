// src/components/codesnake/CodeSnakeLevel6.jsx
import React, { useState } from 'react';

export default function CodeSnakeLevel6({ onBack }) {
  ...
  const puzzlePieces = [
    ...
    { id: 7, code: 'if can_move_down():', type: 'condition' }
  ];

  const correctSolution = [
    'move_right()', 'move_right()', 'collect_berry()',
    'move_down()', 'collect_berry()', 'move_right()', 'collect_berry()',
    'move_down()', 'move_left()', 'move_left()', 'move_left()', 'collect_berry()',
    'move_down()', 'move_right()', 'move_right()', 'move_right()', 'collect_berry()'
  ];
  ...
  const runCode = () => {
    ...
    if (isSolutionCorrect) {
      setResult('Правильно! Змейка собрала все 5 ягод без ошибок!');
      setSnakePosition({ x: 4, y: 4 });
      setBerriesCollected(5);
    } else {
      setResult('Попробуйте еще раз. Нужно собрать все 5 ягод, избегая стен');
    }
  };
      ...
      <header className="bg-black/20 backdrop-blur-sm border-b border-green-500/20">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">Змейка программиста - Уровень 6</h1>
            <button 
              onClick={onBack}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl font-bold text-white">Множество ягод</h2>
                <p className="text-gray-300">Соберите 5 ягод в сложном лабиринте без ошибок</p>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8">
                ...
                <div className="mt-4 text-center text-gray-300">
                  ...
                  <p className="mt-2">Собрано ягод: {berriesCollected}/5</p>
                </div>
              </div>
