  ...
  return (
    <div className="bg-black text-white min-h-screen flex items-center justify-center p-6">
      <div className="bg-gray-800 border border-red-700 rounded-lg shadow-xl w-full max-w-md p-8">
        <h2 className="text-2xl font-bold uppercase mb-6 text-center">Регистрация</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm uppercase mb-1">Имя товарища</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div>
            <label className="block text-sm uppercase mb-1">Подтвердите пароль</label>
            <input
              type="password"
