// src/data/courses/python/lesson3.jsx
import React, { useState, useEffect } from 'react';
import { ArrowLeft, ArrowRight } from 'lucide-react';
// Импортируем список частей
import { subLessonIds as initialSubLessonIds } from './lesson3/index.js';

const Lesson3Wrapper = () => {
  ...
  useEffect(() => {
    ...
    const loadCurrentSubLesson = async () => {
      ...
      try {
        // Путь относительно этого файла: './lesson3/part1.jsx'
        const module = await import(`./lesson3/${currentSubLessonId}.jsx`);
        if (isMounted) {
    ...
    const loadStateForCurrentPart = () => {
      ...
      const currentSubLessonId = subLessonIds[currentPartIndex];
      // Предполагаем lessonId = 3 и slug = 'python'
      const storageKeySuffix = `3_${currentSubLessonId}`;
...
// Флаг для LessonPage
Lesson3Wrapper.hasSubLessons = true;
// Эти свойства могут использоваться LessonPage, если он будет их поддерживать
// Lesson3Wrapper.title = "Типы данных и переменные";
// Lesson3Wrapper.duration = "40 мин";
// Lesson3Wrapper.difficulty = "Начальный";

export default Lesson3Wrapper;