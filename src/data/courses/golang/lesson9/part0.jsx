...
const Part1 = () => {
  ...
  const youtubeVideoId = "ys24Y1a07sg"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239060&hd=2&autoplay=1";
  // -----------------------
