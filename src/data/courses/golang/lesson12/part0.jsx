...
const Part1 = () => {
  ...
  const youtubeVideoId = "ryP0bVYq0d8"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239063&hd=2&autoplay=1";
  // -----------------------
