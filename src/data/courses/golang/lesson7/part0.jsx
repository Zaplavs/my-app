...
const Part1 = () => {
  ...
  const youtubeVideoId = "BR2-bQcZl1s"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239058&hd=2&autoplay=1";
  // -----------------------
