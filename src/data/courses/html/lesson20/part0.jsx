...
const Part1 = () => {
  ...
  const youtubeVideoId = "fjQfOm8O4PA"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239050&hd=2&autoplay=1";
  // -----------------------
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-xl">
        <h2 className="text-2xl font-bold text-white mb-4">Валидация HTML и лучшие практики</h2>
