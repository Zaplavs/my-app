...
const Part1 = () => {
  ...
  const youtubeVideoId = "7Hof6-qkXhU"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239048&hd=2&autoplay=1";
  // -----------------------
