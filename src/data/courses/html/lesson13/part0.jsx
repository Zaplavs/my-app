...
const Part1 = () => {
  ...
  const youtubeVideoId = "KG7zBUIRd3o"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239043&hd=2&autoplay=1";
  // -----------------------
...
Группировка и доступность форм</h2>
