...
const Part1 = () => {
  ...
  const youtubeVideoId = "7TY_K0UwCfY"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239037&hd=2&autoplay=1";
  // -----------------------
