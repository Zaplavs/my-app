...
const Part1 = () => {
  ...
  const youtubeVideoId = "d5etR9T9EJI"; // Пример ID YouTube видео (замените на ваше!)
  
  // Используем предоставленный URL для VK видео
  const vkVideoEmbedUrl = "https://vkvideo.ru/video_ext.php?oid=-185944841&id=456239046&hd=2&autoplay=1";
  // -----------------------
